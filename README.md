...
This is an implementation of the [Knuth and Plass line breaking algorithm](https://onlinelibrary.wiley.com/doi/abs/10.1002/spe.4380111102) using JavaScript. The goal of this project is to optimally set justified text in the browser, and ultimately provide a library for various line breaking algorithms in JavaScript.
...
* [Breaking paragraphs into lines, Donald E. Knuth, Michael F. Plass](https://onlinelibrary.wiley.com/doi/abs/10.1002/spe.4380111102)
